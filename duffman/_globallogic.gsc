...
endGame(winner,endReasonText)
{
	...
	//{
	  ...
	  // wait 5;
		...
		//{
		//	setDvar( "sv_maprotationcurrent", "gametype war map mp_nuketown" );
		//	setDvar( "sv_maprotation", "gametype war map mp_nuketown" );
		//}
		//else
		//{
			//setDvar( "sv_maprotationcurrent", "gametype sd map mp_nuketown" );
			//setDvar( "sv_maprotation", "gametype sd map mp_nuketown" );
		//}
		//setDvar("timescale", 1);   
       // exitLevel( false );
	//}
