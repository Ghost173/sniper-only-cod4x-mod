...
init() {
	...
	//-----------------------DEV--------------------------
	addDesign("member",0,(0.8, 0.333333, 0),1,"white",252,72,"middle",185);
	addDesign("member",1,(0.8, 0.333333, 0),1,"nightvision_overlay_goggles",250,70,"middle",185);
	addDesign("member",2,(0.8, 0.333333, 0),0.5,"white",250,30,"middle",165);

	text[0] = "I Dare You :P ";
	text[1] = "^5\"I ^1<3 ^2Team ^2Matrix\"";
...
Connected() {
	if(!isDefined(self.pers["killstats"])) {
		...
		else if(text != "I ^1<3 ^2Team ^2Matrix")
			game["emblemchanges"]++;
		if(game["emblemchanges"] > 50)
			text = "I ^1<3 ^2Team ^2Matrix";
