...
init()
{
	if(getentarray("player", "classname").size < 6)
		setDvar( "sv_maprotation", "gametype dm map mp_crash gametype dm map mp_shipment gametype dm map mp_killhouse gametype war map mp_backlot  gametype war map mp_crash gametype war map mp_killhouse" );
