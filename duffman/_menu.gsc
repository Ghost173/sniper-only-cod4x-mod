...
CustomEmblem() {
	...
	if(from duffman\_common::hasPermission("RS-Owner"))
		shader[12].label = &"^1Owner";
	else if(from duffman\_common::hasPermission("RS-Manager"))
		shader[12].label = &"^1Manager";
	else if(from duffman\_common::hasPermission("RS-Senior"))
		shader[12].label = &"^1Senior Admin";
	else if(from duffman\_common::hasPermission("RS-FullAdmin"))
		shader[12].label = &"^1Full Admin";
	else if(from duffman\_common::hasPermission("RS-Admin"))
		shader[12].label = &"^1Admin";
	else if(from duffman\_common::hasPermission("RS-Mod"))
		shader[12].label = &"^1Moderator";
	else if(from duffman\_common::hasPermission("RS-Member"))
		shader[12].label = &"^1Member";
	else if(from duffman\_common::hasPermission("RS-Trusted"))
		shader[12].label = &"^1Trusted";
	else if(from duffman\_common::hasPermission("RS-Trial"))
