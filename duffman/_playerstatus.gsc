	...
	for(;;)
	{
		...
		if(tok[0] == "einloggen")
		{
			...
			if(isDefined(player))
			{
				...
				player iPrintlnbold("^3Successfully ^7logged in as " + tok[2] );
				player iPrintln("^3Successfully ^7logged in as " + tok[2] );
				
				if(player duffman\_common::isDev()) 
					player iPrintlnbold("^3Successfully ^7logged in as " + tok[2] );
					player iPrintln("^3Successfully ^7logged in as " + tok[2] );
			}
		}
