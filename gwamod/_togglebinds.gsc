...
Nodify()
{
	...
	for(;;)
	{
     ...
     wait 3;
     self iPrintln("^5Like Us on Facebook-: ^1discord.gg/G2nNqEe");
     wait 4;
     self iPrintln("^1Wallhacks / aimbots are not Allowed.");
     wait 5;
     self iPrintln("^9Server Developed By ^MATRIX ^4Gaming ^3!!!");
     wait 6;
     self iPrintln("^5Visit Our TDM Server-: ^145.32.113.186:28960");
     wait 7;
     self iPrintln("^5server manage by ^4MSS-community");
	}
}
