main()
{
	...
	setDvar( "scr_dom_roundlimit", 1 ); // [0->] (points)
	setDvar( "scr_dom_roundswitch", 1 ); // [0->] (points)
	setDvar( "scr_dom_scorelimit", 50000 ); // [0->] (points)
	...
	setDvar( "scr_war_scorelimit", 30000 ); // [0->] (points)
	...
	setDvar( "scr_dm_scorelimit", 30000 ); // [0->] (points)
	...
	// website
	setDvar( "promod_hud_website", "^0[^2www.tmxgaming-sniper.ml^0]" ); // (avoid "//" here)
