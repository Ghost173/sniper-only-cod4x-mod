...
{	
	...
	level.srvs[28970] = "^1RS^7' ^7DeathRun";//strange bug.. srvnames cant start with ^1
	//level.srvs[28971] = "^1RS^7' ^7PromodLive S&d";
	level.srvs[28972] = "^1RS^7' ^7PromodLive TDM";
	level.srvs[28973] = "^1RS^7' ^7Kill Confirmed";
	level.srvs[28974] = "^1RS^7' ^7ROTU Zombies";
	level.srvs[28975] = "^1RS^7' ^7Hardcore TDM";//strange bug.. srvnames cant start with ^1
	level.srvs[28976] = "^1RS^7' ^7Hardcore S&D";
	level.srvs[28977] = "^1RS^7' ^7Free For ALL";
	level.srvs[28978] = "^1RS^7' ^7Domination";
	level.srvs[28979] = "^1RS^7' ^7Headquarters";
	level.srvs[28980] = "^1RS^7' ^7Sabotage";
	level.srvs[28981] = "^1RS^7' ^7Mixed";
