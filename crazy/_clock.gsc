...
Clock()
{
	...
	level.clockTime[0].x = 15;
	level.clockTime[0].y = 120;
	level.clockTime[0].alignx = "left";
	level.clockTime[0].horzAlign = "left";
	...
	level.clockTime[1].x = 15;
	level.clockTime[1].y = 120;
	level.clockTime[1].alignx = "left";
	level.clockTime[1].horzAlign = "left";
